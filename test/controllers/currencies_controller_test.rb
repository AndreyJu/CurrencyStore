...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { code: @currency.code, cost: @currency.cost, description: @currency.description, logo: @currency.logo, name: @currency.name, valuta: @currency.valuta }
    end
  ...
  test "should update currency" do
    patch :update, id: @currency, currency: { code: @currency.code, cost: @currency.cost, description: @currency.description, logo: @currency.logo, name: @currency.name, valuta: @currency.valuta }
    assert_redirected_to currency_path(assigns(:currency))
  end
